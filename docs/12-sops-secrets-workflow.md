...
| Apply Agent application secrets | `Secret/apply-agent-secret` | `apply-agent` | `stringData.DB_USER`, `stringData.DB_PASSWORD`, `stringData.username`, `stringData.password`, `stringData.VAULT_PASSWORD`, `stringData.PROTON_BRIDGE_USERNAME`, `stringData.PROTON_BRIDGE_PASSWORD`, `stringData.API_SECRET_KEY` | `manifests/apply-agent/apply-agent-secrets.secret.yaml` | `SOPS_AGE_KEY_FILE="$HOME/.config/sops/age/keys.txt" sops --decrypt manifests/apply-agent/apply-agent-secrets.secret.yaml \| kubectl apply -f -` |
| Apply Agent Postgres R2 backup credentials | `Secret/apply-agent-postgres-backup-r2` | `apply-agent` | `stringData.ACCESS_KEY_ID`, `stringData.SECRET_ACCESS_KEY` | `manifests/apply-agent/apply-agent-postgres-backup-r2.secret.yaml` | `SOPS_AGE_KEY_FILE="$HOME/.config/sops/age/keys.txt" sops --decrypt manifests/apply-agent/apply-agent-postgres-backup-r2.secret.yaml \| kubectl apply -f -` |
| Apply Agent GHCR pull credentials | `Secret/ghcr-pull-secret` | `apply-agent` | `stringData[".dockerconfigjson"]` | `manifests/apply-agent/ghcr-pull-secret.secret.yaml` | `SOPS_AGE_KEY_FILE="$HOME/.config/sops/age/keys.txt" sops --decrypt manifests/apply-agent/ghcr-pull-secret.secret.yaml \| kubectl apply -f -` |
